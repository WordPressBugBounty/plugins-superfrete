...
class SuperFreteMiniEnvios extends \WC_Shipping_Method {
    public $free_shipping;
    public $extra_days;
    public $extra_cost;
    public $extra_cost_type;
    
 public function __construct( $instance_id = 'superfrete_mini_envio') {
        ...
        $this->instance_form_fields = array(
            ...
            'title' => array(
                ...
                'default' => __('Entrega via Mini Envios SuperFrete', 'superfrete'),
                'desc_tip'        => true
            ),
              'free_shipping' => array(
